 ...
 */
package edu.ijse.absd.viva.controller;
...
import edu.ijse.absd.viva.service.impl.BookServiceImpl;
...
public class SaveBook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BookDTO bookDTO = new BookDTO(bookName, authorId);
        BookService bookService = new BookServiceImpl();
        bookService.saveBook(connection, bookDTO);
        out.close();
    }
